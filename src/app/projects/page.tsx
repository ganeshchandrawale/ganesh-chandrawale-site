...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Notable Work | Ganesh Chandrawale — Solution Architect',
...
const projects = [
  ...
  },
  {
    ...
    period: '2023 – Present',
    excerpt: 'Architectural thinking on financial certainty in multi-party settlement flows — making complexity defensible, auditable, and scalable.',
    colour: '#1B7A8A',
  },
]
